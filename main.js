...
Sketchedtobedrawn = quick_draw_data_set[random_number];
document.getElementById('Sketchedtobedrawn').innerHTML = 'Sketch To Be Drawn :' + Sketchedtobedrawn;
...
function draw() {
    check_sketch();
if(Sketchedtobedrawn == drawn_sketch){
    answer_holder = "set";
    score++;
    console.log(score);
...
function gotResult(error, results) {
    ...
    document.getElementById('confidence').innerHTML = 'Confidende: ' + Math.round(results[0].confidence * 100) + '%';
